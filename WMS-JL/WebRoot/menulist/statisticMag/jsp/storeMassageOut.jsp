...
<div class="common-black" id="black_block"></div>
	...
	<div class="common-title">
		<div class="condition table" id="title-blackground">
			<span id="title"class="fontB">出库通知</span>
		</div>
		...
		<div class="condition table">
			<button onclick="show_storeout_pop()">出库扫描</button>
		</div>
	</div>
	<div class="common-body">
		<div class="importblock">
			...
			<span id="noResole"class="select-opntion" onclick="select_status($(this))">待出库</span>
			<span id="resoled"class="select-opntion" onclick="select_status($(this))">已出库</span>
		</div>
		<div class="goodslist">
			<table>
				<thead>
					<tr style="background-color: #72c2fa;">
						<th style="width: 8%;">序号</th><th style="width: 12%;">单品名称</th><th style="width: 12%;">型号</th><th style="width: 12%;">SKU</th><th style="width: 12%;">存入仓库</th><th style="width: 12%;">批次</th><th style="width: 12%;">数量</th><th style="width: 10%;">收货人</th><th style="width: 10%;">操作</th>
					</tr>
				</thead>
				<tbody id="goodslistInfo">
					<tr class="select-tr">
						<td>1</td><td>010025</td><td>运动鞋</td><td>A-01</td><td>1号库</td><td>2015646</td><td>80</td><td>李四</td><td><span class="option" onclick="show_su_pop()">编辑</span></td>
					</tr>
				</tbody>
			</table>
		</div>
	...
	<!-- 快速出库弹窗 -->
	<div class="pop-window-1" id="storeout_block">
		...
		<div class="pop-body-block">
			<table class="addgoodsInfo-table font">
				...
				<tr>
					<td class="input-name">库存数量:</td><td class="input-value"><input type="text" readonly="readonly"></td>
				</tr>
				<tr>
					<td class="input-name">操作数量:</td><td class="input-value"><input type="text" ></td>
				</tr>
				<tr>
					<td class="input-name">总数量:</td><td class="input-value"><input type="text" ></td>
				</tr>
			</table>
		</div>
		<div class="pop-option-block">
			<input type="button" value="确认出库" onclick="deal_store_out()">
			<span class="space"></span>
			<input type="button" value="撤销出库" onclick="close_storeout_pop()">
		</div>
	</div>
	<!-- 快速出库结束 -->
