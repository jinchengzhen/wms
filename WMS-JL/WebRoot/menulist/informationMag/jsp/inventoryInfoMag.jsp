...
<div class="common-black" id="black_block"></div>
	...
	<div class="common-title">
		...
		<div class="condition table">
			<span>所在仓库：</span>
			<input id="current_store" type="text" readonly="readonly">
		</div>
		<div class="condition table">
			<span class="space"></span>
			<span class="space"></span>
	...
	<div class="common-body">
		<div class="importblock">
			...
			<span class="import" onclick="">导入原始资料</span>
		</div>
		<div class="goodslist">
			<table>
				<thead>
					<tr style="background-color: #72c2fa;">
						<th style="width: 4%;">序号</th><th style="width: 10%;">货品名称</th><th style="width: 8%;">货品型号</th><th style="width: 8%;">批次</th><th style="width: 8%;">所在库房</th><th style="width: 5%;">所在仓位</th><th style="width: 9%;">现有数量</th><th style="width: 10%;">存入时间</th><th style="width: 10%;">过期时间</th><th style="width: 10%;">校验人</th><th style="width: 12%;">备注</th>
					</tr>
				</thead>
				<tbody id="inventorylistInfo">
					<tr class="select-tr">
						<td>1</td><td>运动鞋</td><td>A-1</td><td>13420826</td><td>1号库</td><td>1</td><td>200双</td><td>2018-12-31</td><td>2018-12-31</td><td>王五</td><td>0</td>
					</tr>
				</tbody>
			</table>
		</div>
	...
	<div class="pop-window-1" id="add_inventoryinfo_block">
		...
		<div class="pop-body-block">
			<table class="addstoreInfo-table font">
				<tr><td class="input-name"><span>所在仓位：</span></td><td class="input-value"><input id="add_storelocation" type="text" class="font"placeholder="请输入仓库具体位置"></td>
				</tr>
				<tr><td class="input-name"><span>货品名称：</span></td><td class="input-value"><input id="add_goodsName"  type="text" class="font"placeholder="请输入长x宽x高" ></td>
				</tr>
				<tr><td class="input-name"><span>货品型号：</span></td><td class="input-value"><input id="add_goodsVersion" type="text" class="font"placeholder="请设置仓位数量，默认为 1" ></td>
				</tr>
				<tr><td class="input-name"><span>批&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;次：</span></td><td class="input-value"><input id="add_batchID" type="text" class="font"placeholder="请选择管理人员" ></td>
				</tr>
				<tr><td class="input-name"><span>数&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;量：</span></td><td class="input-value"><input id="add_total"type="text"class="font"></td>
				</tr>
				<tr><td class="input-name"><span>备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：</span></td><td class="input-value"><input id="add_remark" type="text" class="font"></td>
				</tr>
			</table>
		</div>
