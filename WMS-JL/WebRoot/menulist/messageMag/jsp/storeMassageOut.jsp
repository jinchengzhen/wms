...
<body>
	...
	<div class="common-body">
		<div class="importblock">
			...
			<span id="noResole" class="select-opntion"
				onclick="select_status($(this))">待出库</span> <span id="resoled"
				class="select-opntion" onclick="select_status($(this))">已出库</span>
		</div>
		<div class="goodslist">
			<table>
				<thead>
				...
				<tbody id="goodslistInfo">
					<tr class="select-tr">
						...
						<td>80</td>
						<td>李四</td>
						<td><span class="option" onclick="show_su_pop()">编辑</span></td>
					</tr>
				</tbody>
			</table>
		</div>
	...
	<div class="pop-window-1" id="storeout_block">
		...
		<div class="pop-option-block">
			...
			<span class="space"></span> <input type="button" value="撤销出库"
