...
<div class="common-black" id="black_block"></div>
	...
	<div class="common-body">
		<div class="importblock">
			...
			<span id="noResole"class="select-opntion" onclick="select_status($(this))">待入库</span>
			<span id="resoled"class="select-opntion" onclick="select_status($(this))">已入库</span>
		</div>
		<div class="goodslist">
			<table>
				<thead>
	...
	<div class="pop-window-1" id="storein_block">
		<div class="pop-title-block">
			...
			<div class="pop-title-quit" id="quit_2"><div class="quit-x" onclick="close_storein_pop()"></div></div>
		</div>
		...
		<div class="pop-option-block">
			<input type="button" value="确认入库" onclick="deal_approve()">
			<span class="space"></span>
			<input type="button" value="撤销入库" onclick="close_storein_pop()">
		</div>
	</div>
	<!-- 快速入库结束 -->
