	...
	<div class="common-body">
		<div class="importblock">
			...
			<span id="noResole" class="select-opntion"
				onclick="select_status($(this))">待处理</span> <span id="resoled"
				class="select-opntion" onclick="select_status($(this))">已处理</span>
		</div>
		<div class="goodslist">
			<table>
				<thead>
					<tr style="background-color: #72c2fa;">
						...
						<th style="width: 10%;">单品名称</th>
						<th style="width: 10%;">型号</th>
						<th style="width: 10%;">SKU</th>
						<th style="width: 12%;">批次</th>
						<th style="width: 10%;">原始位置</th>
				...
				<tbody id="goodslistInfo">
					<tr class="select-tr">
						...
						<td>201</td>
						<td>李四</td>
						<td><span class="option" onclick="show_su_pop()">查看</span></td>
					</tr>
				</tbody>
			</table>
		</div>
	...
	<div class="pop-window-1" id="storemove_block">
		<div class="pop-title-block">
			<div class="pop-title-info table">
				<span class="titletext">快速出库</span>
			</div>
			<div class="pop-title-quit" id="quit_2">
				<div class="quit-x" onclick="close_storeout_pop()"></div>
			</div>
		</div>
		<div class="pop-body-block">
			<table class="addgoodsInfo-table font">
				...
				<tr>
					<td class="input-name">货品名称:</td>
					<td class="input-value"><input type="text"></td>
				</tr>
				<tr>
					<td class="input-name">原始位置:</td>
					<td class="input-value"><input type="text" readonly="readonly"></td>
				</tr>
				<tr>
					<td class="input-name">目标位置:</td>
					<td class="input-value"><input type="text" readonly="readonly"></td>
				</tr>
				<tr>
		...
		<div class="pop-option-block">
			<input type="button" value="确认" onclick="deal_store_out()"> <span
				class="space"></span> <input type="button" value="撤销"
				onclick="close_storeout_pop()">
		</div>
	</div>
	<!-- 快速出库结束 -->
