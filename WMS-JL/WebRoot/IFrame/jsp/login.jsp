    ...
    <div class="login">
	    <div class="box png">
			...
			<div class="input">
				<div class="log">
					<div class="name">
						<label>用户名</label><input type="text" class="text" id="userID" placeholder="用户名" name="userID" tabindex="1">
					</div>
					<div class="pwd">
						<label>密　码</label><input type="password" class="text" id="password" placeholder="密码" name="password" tabindex="2">
						<input id="login" type="button" class="submit" tabindex="3" value="登录" onclick="login()">
						<input id="regist" type="button" class="submit" tabindex="3" value="注册"onclick="regist()">
						<div class="check"></div>
					</div>
					<div class="tip" id="basePath" basepath=<%= "\""+basePath+"\"" %> publicKeyExponent=<%="\""+publicKeyExponent+"\"" %> publicKeyModulus=<%="\""+publicKeyModulus+"\"" %> ></div>
				</div>
			</div>
		</div>
